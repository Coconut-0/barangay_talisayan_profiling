...
<html lang="en">
<head>
<title>Barangay Clearance || Brgy. Talisayan Management System</title>
<meta charset="UTF-8">
...
input[name="first"], input[name="last"], input[name="mid"], input[name="com_tax_number"] {
  width: 30%;
  padding: 5px;
  margin: 5px 0 22px 0;
  display: inline-block;
...
<?php
  if(isset($_POST['registerbtn']))
  {
    ...
    $com_tax_number = $_POST['com_tax_number'];
    $date_issued = $_POST['date_issued'];
    $purpose = $_POST['purpose'];
   
    
    $query = "INSERT INTO p_request_barangay_clearance (firstname, midname, lastname, address, com_tax_number, date_issued, date, purpose) VALUE ('$firstname', '$midname', '$lastname', '$address', '$com_tax_number', '$date_issued', CURRENT_TIMESTAMP, '$purpose' )";
...
<form class="certi" action="clearance.php" method="POST">
...
<div class="text-center">
    ...
    <!-- Community Tax Number & Date Issued-->
    <br><label><b>Community Tax Number</b></label>
    <label name="issued"><b>Date Issued:</b></label>
    <br><input type="tel" placeholder="Community Tax Number" name="com_tax_number" id="tax" onkeypress="return onlyNumberKey(event)" required>
    <input type="date" id="dateissued" name="date_issued">

    <!--Purpose on getting the Clearance-->
    <br><label><b>Purpose</b></label><br>
    <input type="text" placeholder="(Ex: Work Documents)" name="purpose" id="pur" required>
